% ===================================================================
% This is the main function of the UAV deterrence project for the 3D
% strategy
%
...
target             = Target(false, 450, 700,  20, deg2rad(270), 5,  350,  12,      deg2rad(45));
targets             = [target];
...
[b_dive, curve_length_dive] = bezierPathdive(world, agents(1), targets(1), edge, inter_mult_dive, offset_mult, 1);
